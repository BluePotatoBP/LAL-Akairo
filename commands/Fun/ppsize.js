...
class PPSize extends Command {
    ...
    async exec(message, { u }) {
        ...
        let sizes = ["An error occurred: Not visible by the human eye", "() (Also considered as a vagina)", "D (Really small, seriously go get penis enlargement surgery",

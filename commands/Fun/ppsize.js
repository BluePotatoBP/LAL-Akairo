...
class PPSize extends Command {
    ...
    async exec(message, { u }) {
        ...
        var sizes = ["An error occurred: Not visible by the human eye", "() (Also considered as a vagina)", "D (Really small, seriously go get penis enlargement surgery",
            "8D (Micropenis)", "8=D (VERY SMOL PP)", "8==D (Still tiny)", "8===D (About average)",
            ...
            "An error occurred: Not measurable (too big)", "8=====D \nhttps://www.youtube.com/watch?v=jXglHzoG_Zs",
            "8■■■■■■■■■■■■■■■■■■■■■■■■D (Bigger than a country dang)", "8∞∞∞∞∞∞∞∞∞∞∞∞∞∞D (MASSIVE PP)"]
        ...
        try {
            let ppembed2 = new Discord.MessageEmbed()
                ...
                .setColor('RANDOM')
                .addField(lang(message, "command.ppsize.embed.field.one"), sizes[~~(Math.random() * sizes.length)])

    ...
    async exec(message, { command }) {
        ...
        if (!command) {
            ...
            if (!command) return message.channel.send(
                embed.setTitle(lang(message, 'command.help.embed.title.one'))
                .setDescription(`${lang(message, 'command.help.embed.title.desc.one')} \`${prefix}help\` ${lang(message, 'command.help.embed.title.desc.two')}`)
            );
            ...
            **${lang(message, 'command.help.embedtwo.desc.six')}** ${command.aliases ? command.aliases.join(', ') : lang(message, 'command.help.embedtwo.desc.seven')}`);
            ...
            embed.setFooter(
                `${lang(message, 'command.help.embedtwo.desc.eight')} ${command.description.syntax ? `${command.description.syntax}` : lang(message, 'command.help.embedtwo.desc.nine')}`
            );
